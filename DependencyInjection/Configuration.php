                ...
                ->arrayNode('view')
                    ...
                    ->children()
                        ...
                        ->arrayNode('view_response_listener')
                            ...
                            ->end()
                            ->validate()
                                ->ifTrue(function ($v) { return !in_array($v['mode'], $this->forceOptionValues); })
                                ->thenInvalid('The view_response_listener "mode" does not support %s. Please choose one of '.json_encode($this->forceOptionValues))
                            ->end()
                            ->canBeEnabled()
                            ->children()
                                ->scalarNode('service')->defaultNull()->end()
